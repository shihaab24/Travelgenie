import React, { useState } from 'react';
    ...
    import { Wand2, Send, Download, Share2, Loader } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
          ...
          >
            <textarea
              ...
              className="w-full p-4 pr-20 bg-gray-800 border-2 border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all text-lg resize-none"
              rows={3}
            />
            <button
              onClick={handleGeneratePlan}
              disabled={isLoading}
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-3 rounded-full hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
            >
